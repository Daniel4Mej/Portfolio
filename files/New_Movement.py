...
COM_PORT = "COM3"
CAL_PATH = r"C:\Users\Daniel\Desktop\ARV4\ARbot_safe.cal"
SAFETY_MARGIN = 2.0
POSITIONS_FILE = "ar4_saved_positions.json"
...
class AR4Safe:
    ...
    def home(self, speed=20):
        return self.move(0, 0, 0, 0, 0, 0, speed=speed)
